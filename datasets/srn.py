...
SHAPENET_DATASET_ROOT = "/home/hamdol/SRN" # Change this to your data directory
...
class SRNDataset(SharedDataset):
    def __init__(self, cfg,
        ...
        self.base_path = os.path.join(SHAPENET_DATASET_ROOT, "srn_{}/{}_{}".format(cfg.data.category, cfg.data.category, self.dataset_name))
